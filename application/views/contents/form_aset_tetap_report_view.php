<div class="box box-default">
    <form id="form_data" target="_blank" method="get" action="<?php echo $action ?>">
        <div class="box-header with-border">
            <div class="pull-left">
                <h4><strong>LAPORAN <?php echo strtoupper($this->title) ?></strong></h4>
            </div>
        </div>
        <div class="box-body">
            <table class="table table-bordered">
                    ...
                    <td>
                        <select name="kib" id="kib" class="form-control">
                            <?php foreach (config_item('kib') as $key => $value) { ?>
                                <option value="<?php echo $key ?>"><?php echo $value['id'].' | '.$value['name'] ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            <input type="text" id="kode_skpd" name="kode_skpd" class="form-control" value="<?php echo isset($data->kode_skpd)?$data->kode_skpd:'' ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input readonly type="text" id="nama_skpd" name="nama_skpd" class="form-control" value="<?php echo isset($data->nama_skpd)?$data->nama_skpd:'' ?>">        
                    </td>
                </tr>
                <tr>
