    ...
    <form id="form_data" method="post">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><input type="text" id="stok" name="stok" class="input-uang form-control" value="<?php echo isset($data->stok)?$data->stok:'' ?>"></td>
            </tr>
        </table>
        </div>
        <div class="box-footer">
            <button type="button" class="btn_action btn btn-primary" data-redirect="<?php echo base_url('persediaan/index').get_query_string() ?>" data-action="<?php echo $action ?>" data-form="#form_data" data-idle="<i class='fa fa-save'></i> Simpan" data-process="Menyimpan..."><i class='fa fa-save'></i> Simpan</button>
            <button type="button" class="btn_close btn btn-default" data-redirect="<?php echo base_url('persediaan/index').get_query_string() ?>"><i class='fa fa-close'></i> Kembali</button>
        </div>
    </form>
</div>