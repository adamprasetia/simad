...
tinymce.PluginManager.add('linkcustom', function (editor, url) {
  ...
  editor.ui.registry.addMenuItem('linkcustom', {
    text: 'Custom Link Article Kompas Book',
    onAction: function () {
      /* Open window */
      openDialog();
    }
